...
If you copy the script to your current working directory, you can run it using a command such as

```sh
Rscript run_seeker.R <path/to/study>.yml <path/to/parent/directory>
```

A somewhat fancier option, which saves stdout and stderr to a log file, would be something like
