...
The `seeker` package also includes an example shell script for fetching and processing a microarray dataset. Download the fileS to your working directory:
